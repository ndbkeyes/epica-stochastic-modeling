...
class DataSet(MftwdfaAlg,OUModel):
    ...
    ##### constructor - read & clean data
    # path = string of text file location to read from
    def __init__(self, path):
        ...
        self.data_ts = ts["data"]                                               # save as object attribute



    ##### set up for OU modeling
    # periods = number of periods to have, points = number of points per period
